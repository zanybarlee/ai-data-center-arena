...
// Agent data collections for different categories

export const predictiveMaintenanceAgents = [
  {
    id: "pm-001",
...
export const energyOptimizationAgents = [
  {
    id: "eo-001",
...
export const designBuildAgents = [
  {
    id: "db-001",
